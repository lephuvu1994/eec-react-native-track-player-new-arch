...
import type { AnimateToPositionType, BottomSheetProps } from '@gorhom/bottom-sheet/lib/typescript/components/bottomSheet/types';
import type { ANIMATION_STATE, KEYBOARD_STATE, SCROLLABLE_STATE, SCROLLABLE_TYPE, SHEET_STATE } from '@gorhom/bottom-sheet/lib/typescript/constants';
import type { Scrollable, ScrollableRef } from '@gorhom/bottom-sheet/lib/typescript/types';
