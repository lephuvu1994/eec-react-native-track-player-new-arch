...
@objc(RNTrackPlayerImpl)
public class RNTrackPlayerImpl: NSObject, AudioSessionControllerDelegate {
    // MARK: - Attributes

    // Add property for the Objective-C bridge
    @objc public weak var delegate: RNTrackPlayerImplDelegate? = nil
...
@objc public protocol RNTrackPlayerImplDelegate {
    func sendEvent(name: String, body: Any)
}

extension RNTrackPlayerImpl {
