...
import { Constants } from "../NativeTPMusicModule.js";
export let Capability = function (Capability) {
  ...
  Capability[Capability["Like"] = Constants?.CAPABILITY_LIKE ?? 13] = "Like";
  Capability[Capability["Dislike"] = Constants?.CAPABILITY_DISLIKE ?? 14] = "Dislike";
  Capability[Capability["Bookmark"] = Constants?.CAPABILITY_BOOKMARK ?? 15] = "Bookmark";
  return Capability;
}({});
